...
$clientScript->registerCssFile($path_theme.'/Litera/bootstrap.css');
$clientScript->registerCssFile($path_theme.'/Litera/bootstrap.min.css');
$clientScript->registerCssFile($path_theme.'/css/fonts.min.css');
// $clientScript->registerCssFile($path_theme.'/css/web.css');

// $clientScript->registerCssFile($path_theme.'/web/Web_1920___1.css');
...
// $clientScript->registerScriptFile($path_theme.'/web/Web_1920___1.js',CClientScript::POS_END);
