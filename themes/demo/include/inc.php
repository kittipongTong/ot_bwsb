...
<?php
// $clientScript->registerCssFile($path_theme.'/js/plugins/chartist/css/chartist.min.css');
...
$clientScript->registerCssFile($path_theme.'/dist/mtr-datepicker.min.css');
...
// $clientScript->registerScriptFile($path_theme.'/js/custom.min.js',CClientScript::POS_END);
  ...
  // $clientScript->registerScriptFile($path_theme.'/src/bootstrap-input-spinner.js',CClientScript::POS_END);
  ...
  // $clientScript->registerScriptFile('https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.0.0-alpha14/js/tempusdominus-bootstrap-4.min.js',CClientScript::POS_END);
?>
